      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Grand Mark Website.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Grand Mark Website, accessible
            from{" "}
            <a
              href="https://grandMarkWebsite.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://grandMarkWebsite.com
            </a>
          </p>
        </li>
        <li>
